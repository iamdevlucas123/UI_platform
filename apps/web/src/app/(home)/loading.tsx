 ...
 *
 * Vive em `app/(home)/` (route group — não afeta a URL, `/` continua `/`)
 * em vez de `app/loading.tsx` para não cascatear para outras rotas: um
 * `loading.tsx` de ancestral comum quebraria o status HTTP de qualquer rota
 * que chame `notFound()`, como `/category/[slug]` (ver o comentário lá).
 */
